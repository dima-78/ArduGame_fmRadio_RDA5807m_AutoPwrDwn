...
EMPTY_INTERRUPT (INT6_vect) ///HERE ERROR COMPILATION NEED SHOULD SEE!!!
...
const uint8_t PROGMEM Bat1[] = {0x7F, 0xFC, 0x80, 0x02, 0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x80, 0x02, 0x7F, 0xFC};
const uint8_t PROGMEM Bat2[] = {0x7F, 0xFC, 0x80, 0x02, 0xA0, 0x01, 0xA0, 0x01, 0xA0, 0x01, 0xA0, 0x01, 0xA0, 0x01, 0xA0, 0x01, 0x80, 0x02, 0x7F, 0xFC};
const uint8_t PROGMEM Bat3[] = {0x7F, 0xFC, 0x80, 0x02, 0xA8, 0x01, 0xA8, 0x01, 0xA8, 0x01, 0xA8, 0x01, 0xA8, 0x01, 0xA8, 0x01, 0x80, 0x02, 0x7F, 0xFC};
const uint8_t PROGMEM Bat4[] = {0x7F, 0xFC, 0x80, 0x02, 0xAA, 0x01, 0xAA, 0x01, 0xAA, 0x01, 0xAA, 0x01, 0xAA, 0x01, 0xAA, 0x01, 0x80, 0x02, 0x7F, 0xFC};
const uint8_t PROGMEM Bat5[] = {0x7F, 0xFC, 0x80, 0x02, 0xAA, 0x81, 0xAA, 0x81, 0xAA, 0x81, 0xAA, 0x81, 0xAA, 0x81, 0xAA, 0x81, 0x80, 0x02, 0x7F, 0xFC};
const uint8_t PROGMEM Bat6[] = {0x7F, 0xFC, 0x80, 0x02, 0xAA, 0xA1, 0xAA, 0xA1, 0xAA, 0xA1, 0xAA, 0xA1, 0xAA, 0xA1, 0xAA, 0xA1, 0x80, 0x02, 0x7F, 0xFC};
const uint8_t PROGMEM Bat7[] = {0x7F, 0xFC, 0x80, 0x02, 0xAA, 0xA9, 0xAA, 0xAD, 0xAA, 0xAD, 0xAA, 0xAD, 0xAA, 0xAD, 0xAA, 0xA9, 0x80, 0x02, 0x7F, 0xFC};
...
void moveCircle() {
  while (true) {
    ...
    //arduboy.fillCircle(circlePos, 7, 7, BLACK);
    circlePos += 8;
    if (circlePos > 119) {
      circlePos = 7;
      break;
    ...
    //arduboy.fillCircle(circlePos, 7, 7, WHITE);
    arduboy.display();
    //arduboy.clear(); ///****
    delay(100);
  }
...
void viewVolts () { //TODO
  ...
  */
  if (Voltage > 85) arduboy.drawBitmap (10, 0, 2, 10, Bat7, WHITE);
  else if (Voltage > 70) arduboy.drawBitmap (10, 0, 2, 10, Bat6, WHITE);
  else if (Voltage > 55) arduboy.drawBitmap (10, 0, 2, 10, Bat5, WHITE);
  else if (Voltage > 40) arduboy.drawBitmap (10, 0, 2, 10, Bat4, WHITE);
  else if (Voltage > 25) arduboy.drawBitmap (10, 0, 2, 10, Bat3, WHITE);
  else if (Voltage > 10) arduboy.drawBitmap (10, 0, 2, 10, Bat2, WHITE);
  else arduboy.drawBitmap (10, 0, 2, 10, Bat1, WHITE);
}
